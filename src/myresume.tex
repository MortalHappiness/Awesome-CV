...
% \photo[circle,left]{./profile}
\name{}{Chi-Sheng Liu}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
% \address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

\mobile{(+886) 985-430-732}
\email{mail@chishengliu.com}
%\dateofbirth{January 1st, 1970}
\homepage{chishengliu.com}
\github{MortalHappiness}
\linkedin{chishengliu}
% \gitlab{gitlab-id}
